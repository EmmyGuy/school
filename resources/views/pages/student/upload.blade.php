			...
			<div class="chute-bin1 stretch1 btn-dimmer mt20">
				...
				<div class="tab-content pn br-n bg-none allcp-form-list">
					...
					<ul class="nav list-unstyled" role="tablist">
						...
						<li class="nav-label"> Students Details </li>
						<li>
							<a class="btn btn-primary btn-gradient btn-alt btn-block item-active br-n" href="#login" role="tab" data-toggle="tab"> Upload Sheet </a>
						</li>
					</ul>
