        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <textarea id="message" name="message" class="mytextarea" value="" required></textarea>
                </div>
...
<script>
    ...
    $('.send_notification').click(function () {
        ...
        if(defalut_id.length < 1 ){
            swal(' Please check at least one student to send notification!');
        }else{
            tinyMCE.triggerSave();
                ...
                $.ajax({
                    ...
                    url: '{!! route("students.notify_students_via_sms") !!}',
                    type: "POST",
                //   dataType: 'json',
