...
<div class="card-header bg-white header-elements-inline">
        <h6 class="card-title"><b>Starlet High School Application</b></h6>
    ...
    <form id="ajax_reg"  enctype="multipart/form-data" class="steps-validation"  data-fouc>
        ...
        <fieldset>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ $data['applicant']->application_no ?? '' }}" name="applicantion_num" readonly type="text" class="form-control" placeholder="Ignore Please...">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Examinaiton Centre: <span class="text-danger">*</span></label>
                        <input value="{{ $data['applicant']->examination_hall ?? '' }}" required type="text" name="exam_center" placeholder="Examination centre" class="form-control">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input name="dob" value="{{ $data['applicant']->applicant_dob ?? '' }}" type="date" class="form-control date-pick" placeholder="Select Date...">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('photo') }}" accept="image/*" type="file" name="photo" require class="form-input-styled" >
        ...
        <fieldset>
            ...
            <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label>Name of person who picks the child from school: <span class="text-danger">*</span></label>
                        <input value="{{ $data['applicant']->name_of_peson_who_picks_ward ?? ''  }}" type="text" require name="person_who_pick_child" class="form-control" placeholder="" >
                    </div>
                </div>
            </div>
